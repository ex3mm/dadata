...
/**
 * Endpoint для получения подсказок по банкам.
 */
final class SuggestBankEndpoint extends AbstractEndpoint
{
    protected function getPath(): string
    {
        return '/suggestions/api/' . self::API_VERSION . '/rs/suggest/bank';
    }
