...
/** DTO подсказки ФИО от DaData API */
final readonly class FioSuggestionResponseDto implements DtoInterface
{
    public function __construct(
        public string $value,
        public string $unrestrictedValue,
        public FioDataDto $data,
    ) {
    }
    ...
    public static function fromArray(array $data, string $rawResponse = ''): static
    {
        ...
        return new self(
            ...
            data: FioDataDto::fromArray($dataArray, $rawResponse),
        );
    }
