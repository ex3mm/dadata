...
use Ex3mm\Dadata\Endpoints\Suggest\FindPartyEndpoint;
...
final class FindPartyEndpointTest extends TestCase
{
    private function createEndpoint(): FindPartyEndpoint
    {
        ...
        return new FindPartyEndpoint($client, $config);
    }
    ...
    public function test_get_path_returns_correct_api_path(): void
    {
        ...
        $this->assertSame('/suggestions/api/4_1/rs/findById/party', $method->invoke($endpoint));
    }

    public function test_parse_response_returns_collection(): void
    {
        $endpoint = $this->createEndpoint();
        $fixture  = file_get_contents(__DIR__ . '/../../fixtures/find_party_response.json');
