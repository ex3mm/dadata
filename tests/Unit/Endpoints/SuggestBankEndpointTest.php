...
use Ex3mm\Dadata\Endpoints\Suggest\SuggestBankEndpoint;
...
final class SuggestBankEndpointTest extends TestCase
{
    private function createEndpoint(): SuggestBankEndpoint
    {
        ...
        return new SuggestBankEndpoint($client, $config);
    }
    ...
    public function test_get_path_returns_correct_api_path(): void
    {
        ...
        $this->assertSame('/suggestions/api/4_1/rs/suggest/bank', $method->invoke($endpoint));
    }

    public function test_parse_response_returns_collection(): void
    {
        $endpoint = $this->createEndpoint();
        $fixture  = file_get_contents(__DIR__ . '/../../fixtures/suggest_bank_response.json');
